...
public class PetriNetDocHLAPI implements HLAPIRootClass{
	...
	public PetriNetDocHLAPI(){//BEGIN CONSTRUCTOR BODY
		System.out.print("before fact");
		System.out.print("about to call init");
	//	System.out.printf("eisntance: %s ", PtnetFactoryImpl.eINSTANCE.toString());
		PtnetFactoryImpl factimpl = new PtnetFactoryImpl();
		System.out.print("after instance");
		PtnetFactory fact = PtnetFactoryImpl.init();
		System.out.print("after fact");
		synchronized(fact){
			System.out.print("before item");
			item = fact.createPetriNetDoc();
			System.out.print("after item");
			}
