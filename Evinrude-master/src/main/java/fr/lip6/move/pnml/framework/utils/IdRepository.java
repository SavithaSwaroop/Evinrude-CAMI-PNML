...
public final class IdRepository {
	 ...
	 * @type Map
	 */
	public static ConcurrentMap<String, Object> myHash; // NOPMD by ggiffo on 7/1/08
	/**
	 ...
	 */
	public synchronized final static String generateFreeId(String prefix, Object obj)
			throws InvalidIDException {
	 ...
	 */
	public final synchronized static String generateFreeId(Object obj) throws InvalidIDException {
	 ...
	 * @throws InvalidIDException
	 */
	private final synchronized static String generateId(String prefix, Object obj) throws InvalidIDException {
		final Random generator = new Random(new Date().getTime());
		long rand = Math.abs(generator.nextLong());
	 ...
	 */
	public final synchronized static String generatePrefix() {
