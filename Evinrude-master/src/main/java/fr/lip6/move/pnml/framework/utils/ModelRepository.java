...
public final class ModelRepository {
	 ...
	 */
	private static ConcurrentMap<String, ModelRepositoryUnit> documents;

	/**
	 * The current default ID.
	 */
	private static String currentDocWSId;
	 ...
	 */
	public static String getCurrentDocWSId() {
		String res;
	 ...
	 */
	public synchronized static IdRepository getCurrentIdRepository()
			throws VoidRepositoryException {
		if (documents == null || documents.isEmpty()) {
			throw new VoidRepositoryException(
