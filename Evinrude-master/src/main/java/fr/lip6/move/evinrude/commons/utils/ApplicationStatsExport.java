...
public final class ApplicationStatsExport {
	 ...
	 * * Utility class to retrieve / display:
  * <Ul>
  * <Li> The list of the symbols of the application </ li>
  * <Li> The dependency graph of the application </ li>
  * </ Ul>
	 */
	 ...
	 * Extract the symbol table of the application <br>
*param Application The application concerned
*return The caratcère string containing all symbols
* /dropoff window
	 */
