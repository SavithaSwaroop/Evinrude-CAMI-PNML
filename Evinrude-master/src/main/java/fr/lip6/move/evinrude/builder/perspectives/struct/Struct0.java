 ...
 * * Definition of a structural construction rule (STRUCT0) <br
 * @author Jean-Baptiste Voron
 */
/**
 * Definition of structural construction rule ( STRUCT0 ) <br>
 * Definition of a structural building rule ( STRUCT0 ) <br
 * @ Author Jean-Baptiste Voron
 * @author sneeth
 *
 */
