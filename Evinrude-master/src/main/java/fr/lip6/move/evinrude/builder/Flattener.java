...
public final class Flattener {
	...
	public void flatten(IExecutable executable) throws EvinrudeException {
		...
		CamiExport.dumpcamiRepresentation((IModel) executable.getModel(), "flat", executable.getFolder());
	//	PNMLExport.dumpPNMLRepresentation((IModel) executable.getModel(), "flat", executable.getFolder());
