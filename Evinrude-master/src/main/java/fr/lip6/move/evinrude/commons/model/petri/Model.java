...
public class Model extends SubModel implements IModel {
	 ...
	 * / **dropoff window
* Manufacturer Model
*param Exe executable that is being modeled
* /dropoff window
	 */
	...
	/** {@inheritDoc}
	 * Open Declaration void fr.lip6.move.evinrude.commons.model.petri.Model.enqueueNewCfg (ICFG cfg)
*Override
*{}inheritDoc
*Specified by: enqueueNewCfg (...) in IModel
parameters:
*cfg adds a CFG to deal with, if it is already in the queue, or if it has already been processed it is ignored.
	 */
	@Override
