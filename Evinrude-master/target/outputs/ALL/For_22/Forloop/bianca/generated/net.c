...
unsigned int next(global_table_t* global_table, process_t* process, state_t* current, event_t event) {
  ...
  switch (current->place) {
    ...
    case P0_15_ENTRY: {
      ...
      /* Duplique l'état courant du process (Pour la transition structurelle 0_15_2_to_0_15_4 */
    ...
    case P0_15_4: {
      state_t struct_state;
      /* Duplique l'état courant du process (Pour la transition structurelle 0_15_6_to_0_15_EXIT */
      struct_state = dup_state(*current);
