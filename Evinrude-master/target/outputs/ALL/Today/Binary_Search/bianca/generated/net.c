...
unsigned int next(global_table_t* global_table, process_t* process, state_t* current, event_t event) {
  ...
  switch (current->place) {
    ...
    /* Place 0_45_5_144___builtin_puts_pre */
    case P0_45_5_144___BUILTIN_PUTS_PRE: {

      switch (event.type) {
        case __BUILTIN_PUTS: {
          /* On change l'état... */
            current->place = P0_45_5_144___BUILTIN_PUTS_POST;
            return P0_45_5_144___BUILTIN_PUTS_PRE;
        }
    ...
    /* Place 0_45_2_119_printf_pre */
    case P0_45_2_119_PRINTF_PRE: {

      switch (event.type) {
        case PRINTF: {
          /* On change l'état... */
            current->place = P0_45_5_144___BUILTIN_PUTS_PRE;
            return P0_45_2_119_PRINTF_PRE;
        }
        default: return ERROR;
      }
    }
    ...
    case P0_45_ENTRY: {
      ...
      switch (event.type) {
        case __BUILTIN_PUTS: {
          /* On change l'état... */
            current->place = P0_45_2_119_PRINTF_PRE;
            return P0_45_ENTRY;
        }
        default: return ERROR;
      }
