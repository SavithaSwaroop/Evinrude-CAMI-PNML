...
unsigned int next(global_table_t* global_table, process_t* process, state_t* current, event_t event) {
  ...
  switch (current->place) {
    ...
    /* Place 0_46_5_307___builtin_puts_pre */
    case P0_46_5_307___BUILTIN_PUTS_PRE: {

      switch (event.type) {
        case __BUILTIN_PUTS: {
          /* On change l'état... */
            current->place = P0_46_5_308_EXIT_PRE;
            return P0_46_5_307___BUILTIN_PUTS_PRE;
        }
        default: return ERROR;
      }
    }

    /* Place 0_46_9_335_fclose_pre */
    case P0_46_9_335_FCLOSE_PRE: {

      switch (event.type) {
        case FCLOSE: {
          /* On change l'état... */
            current->place = P0_46_9_336_FCLOSE_PRE;
            return P0_46_9_335_FCLOSE_PRE;
        }
        default: return ERROR;
      }
    }
    ...
    case P0_46_ENTRY: {
      ...
      switch (event.type) {
        case __BUILTIN_PUTS: {
          /* On change l'état... */
            current->place = P0_46_2_278_FOPEN_PRE;
            return P0_46_ENTRY;
        }
        default: return ERROR;
      }
    ...
    case P0_46_4_296_FOPEN_POST: {
      ...
      switch (event.type) {
        case __BUILTIN_PUTS: {
          /* On change l'état... */
            current->place = P0_46_9_335_FCLOSE_PRE;
            return P0_46_4_296_FOPEN_POST;
        }
        case FCLOSE: {
          /* On change l'état... */
            current->place = P0_46_5_307___BUILTIN_PUTS_PRE;
            return P0_46_4_296_FOPEN_POST;
        }
        default: return ERROR;
      }
    ...
    /* Place 0_46_2_278_fopen_pre */
    case P0_46_2_278_FOPEN_PRE: {

      switch (event.type) {
        case FOPEN: {
          /* On change l'état... */
            current->place = P0_46_2_278_FOPEN_POST;
            return P0_46_2_278_FOPEN_PRE;
        }
        default: return ERROR;
      }
    }

    /* Place 0_46_5_308_exit_pre */
    case P0_46_5_308_EXIT_PRE: {

      switch (event.type) {
        case EXIT: {
          /* On change l'état... */
            current->place = PGLOBAL_EXIT;
            return P0_46_5_308_EXIT_PRE;
        }
        default: return ERROR;
      }
    }
    ...
    /* Place 0_46_9_336_fclose_pre */
    case P0_46_9_336_FCLOSE_PRE: {

      switch (event.type) {
        case FCLOSE: {
          /* On change l'état... */
            current->place = PGLOBAL_EXIT;
            return P0_46_9_336_FCLOSE_PRE;
        }
        default: return ERROR;
      }
    }
